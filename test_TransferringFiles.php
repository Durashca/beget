        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Что нужно для передачи данных с телефона на компьютер по проводу?</p>
                    <div>
                        <div class="block_radio">
                             <input type="radio" id="option1" name="option" value="1" /> 
                             <label for="option1" style="margin-left: 10px;"> Включить GPS.</label> </div>
                        <div class="block_radio" >
                             <input type="radio" id="option2" name="option" value="2" /> 
                             <label for="option2" style="margin-left: 10px;">Репетитор по програмированию.</label> </div>
                        <div class="block_radio"> 
                            <input type="radio" id="option3" name="option" value="3" /> 
                            <label for="option3" style="margin-left: 10px;">Бумажка с ручкой.</label> </div>
                        <div class="block_radio"> 
