        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Что нужно для удаления приложений с компьютера ?</p>
                    <div>
                        <div class="block_radio">
                            <input type="radio" id="option1" name="option" value="1" />
                            <label for="option1" style="margin-left: 10px;">USB-кабель для подключения телефона к компьютеру.</label>
                        </div>
                        <div class="block_radio">
                            <input type="radio" id="option2" name="option" value="2" />
                            <label for="option2" style="margin-left: 10px;">Репетитор по программированию.</label>
                        </div>
                        <div class="block_radio">
                            <input type="radio" id="option3" name="option" value="3" />
                            <label for="option3" style="margin-left: 10px;">Программа для удаления приложений.</label>
                        </div>
                        <div class="block_radio">
            ...
            <script>
                ...
                document.querySelector('#createPageButton').addEventListener('click', function() {
                    ...
                    if (checked) {
                        ...
                        // правильный ответ: 3 (Программа для удаления приложений) 
                        if (radioButtons[correctAnswer - 1].checked) {
                            let result_arr = JSON.parse(localStorage.getItem('results')) || [false];
                            result_arr[7] = true;
                            // сохраняем результат удаления приложений в локальном хранилище 
