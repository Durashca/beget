        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Выберите способ входа, которого не существует?</p>
                    <div>
                        <div class="block_radio">
                             <input type="radio" id="option1" name="option" value="1" /> 
                             <label for="option1" style="margin-left: 10px;">С помощью графического пароля.</label> </div>
                        <div class="block_radio">
                             <input type="radio" id="option2" name="option" value="2" /> 
                             <label for="option2" style="margin-left: 10px;">С помощью распознания отпечатка пальца.</label> </div>
                        <div class="block_radio"> 
                            <input type="radio" id="option3" name="option" value="3" /> 
                            <label for="option3" style="margin-left: 10px;">С помощью ключа безопасности.</label> </div>
                        <div class="block_radio"> 
                            <input type="radio" id="option4" name="option" value="4" /> 
                            <label for="option4" style="margin-left: 10px;">С помощью танцевального жеста.</label> </div>
                    </div>
                    ...
                    <span id="transition_warning"
                         ...
                         <button id="createPageButton" type="button" class="btn btn-outline-success"> 
                            <a class="nav-link active" href="scoring_points.php">Завершить</a> 
                        </button> 
                    </span>
                    </div>
                </div>
