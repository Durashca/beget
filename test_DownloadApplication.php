    ...
    <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <p>Как скачать приложение с интернет-магазина?</p>
                <div>
                    <div class="block_radio">
                        <input type="radio" id="option1" name="option" value="1" />
                        <label for="option1" style="margin-left: 10px;">Нажать на кнопку "Скачать" на странице приложения.</label>
                    </div>
                    <div class="block_radio">
                        <input type="radio" id="option2" name="option" value="2" />
                        <label for="option2" style="margin-left: 10px;">Нажать на кнопку "Заказать" на странице приложения.</label>
                    </div>
                    <div class="block_radio">
                        <input type="radio" id="option3" name="option" value="3" />
                        <label for="option3" style="margin-left: 10px;">Нажать на кнопку "Купить" на странице приложения.</label>
                    </div>
                    <div class="block_radio">
                        <input type="radio" id="option4" name="option" value="4" />
                        <label for="option4" style="margin-left: 10px;">Нажать на кнопку "Регистрация" на странице приложения.</label>
                    </div>
                </div>
                ...
                <span id="transition_warning"
                    ...
                    <button id="createPageButton" type="button" class="btn btn-outline-success">
                        <a class="nav-link active" href="test_UninstallingApplication.php">Ответить</a>
                    </button>
                </span>
                </div>
            </div>
